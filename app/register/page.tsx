    ...
    <div className="min-h-screen bg-[#F9F5F0] relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto px-6 py-12 relative z-10">
        <div className="bg-gradient-to-br from-[#F5E6D3] to-[#E8D5B7] rounded-3xl p-8 border-2 border-[#D4A574] shadow-lg">
          <h1 className="text-3xl font-bold text-[#8B6F47] mb-6 text-center">Create Account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-[#8B6F47] font-semibold mb-2">
                Name
              </label>
              <input
                id="name"
          ...
          <div className="mt-6 text-center">
            <p className="text-[#8B6F47]">
              ...
              <Link href="/login" className="text-[#D4A574] hover:text-[#8B6F47] font-semibold underline">
                Login
              </Link>
            </p>
          </div>
