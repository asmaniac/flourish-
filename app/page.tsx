  ...
  return (
    <div className="h-screen bg-[#F9F5F0] relative overflow-hidden flex flex-col">
      ...
      <section className="max-w-7xl mx-auto px-6 py-8 text-center relative z-10 flex-shrink-0">
        ...
        <Link 
          href="/product"
          className="inline-block btn-primary text-white px-10 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105"
        >
          Get Started
        </Link>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-8 relative z-10 flex-1 flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {/* Mood Tracking Card */}
          <Link href="/mood-tracker" className="card-polished rounded-3xl p-8 text-center card-hover cursor-pointer block">
          ...
          {/* Journaling Card */}
          <Link href="/journal" className="card-polished rounded-3xl p-8 text-center card-hover cursor-pointer block">
          ...
          {/* AI Insights Card */}
          <Link href="/ai-insights" className="card-polished rounded-3xl p-8 text-center card-hover cursor-pointer block">
            <div className="w-24 h-24 bg-gradient-to-br from-[#E8D5B7] to-[#D4A574] rounded-full mx-auto mb-5 flex items-center justify-center shadow-md">
              <svg className="w-12 h-12 text-[#8B6F47]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
